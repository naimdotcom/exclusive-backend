...
const emailTemplate = (firstName, Otp, expirationTime) => {
...
const SendMail = async (firstName, Otp, email, expirationTime) => {
  try {
    const info = await transporter.sendMail({
      from: process.env.HOST_MAIL,
      to: email,
      subject: "Verification Email  ✔",
      html: emailTemplate(firstName, Otp, expirationTime),
